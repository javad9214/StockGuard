...
import ir.yar.anbar.ui.viewmodels.InvoiceListEvent
import ir.yar.anbar.ui.viewmodels.InvoiceListViewModel
...
private fun ProductItemCard(
    product: ir.yar.anbar.domain.model.Product,
    invoiceProduct: ir.yar.anbar.domain.model.InvoiceProduct
) {
    ElevatedCard(
        modifier = Modifier.fillMaxWidth(),
        colors = CardDefaults.elevatedCardColors(
